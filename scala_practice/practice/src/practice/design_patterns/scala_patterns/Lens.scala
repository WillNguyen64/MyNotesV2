...
// Lens pattern - use this to set properties of an immutable object that is in a deep object hierarchy
// Use third-party library like Scalaz or Monocle to implement lenses.
